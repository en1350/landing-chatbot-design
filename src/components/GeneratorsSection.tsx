...
const GENERATORS: { type: GeneratorType; icon: string; title: string; desc: string; accent: string }[] = [
  {
    ...
    desc: "Полный план урока с целями, этапами и домашним заданием под вашу тему и класс.",
    accent: "#1F5F52",
  },
  {
    type: "game",
    ...
    desc: "Игровые механики и сценарии для вовлечения учеников: викторины, квесты, командные бои.",
    accent: "#E86A3C",
  },
  {
    type: "intensive",
