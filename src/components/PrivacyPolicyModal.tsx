    ...
    <Dialog open={open} onOpenChange={(v) => !v && onClose()}>
      <DialogContent className="max-w-lg max-h-[85vh] overflow-y-auto">
        ...
        <div className="space-y-3 text-sm leading-relaxed text-muted-foreground mt-2">
          ...
          <p>
            Сервис обеспечивает защиту передаваемой и хранимой информации в соответствии с Федеральным
            законом от 27.07.2006 № 149-ФЗ «Об информации, информационных технологиях и о защите информации»:
            данные передаются по защищённому соединению (HTTPS), доступ к базе данных и файловому хранилищу
            ограничен, а меры защиты применяются соразмерно рискам неправомерного доступа, уничтожения,
            изменения, блокирования, копирования или распространения информации.
          </p>
          <p>
