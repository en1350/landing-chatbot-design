        ...
        <div className="mt-6">
          ...
          <Tabs defaultValue="usage">
            ...
            <TabsContent value="privacy" className="mt-4 space-y-3 text-sm leading-relaxed text-muted-foreground">
              ...
              <p>
                Мы обрабатываем персональные данные (email, имя) в соответствии с 152-ФЗ «О персональных
                данных»: тему запроса, класс/возраст и загруженные изображения тетрадей — для генерации
                результата и проверки работ.
              </p>
              <p>
              ...
              <p>
                В соответствии с 149-ФЗ «Об информации, информационных технологиях и о защите информации»
                данные передаются по защищённому соединению (HTTPS), доступ к базе данных и файловому
                хранилищу ограничен и защищён от неправомерного доступа.
              </p>
